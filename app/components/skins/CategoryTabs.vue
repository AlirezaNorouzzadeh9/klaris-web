  ...
  <div class="sticky top-16 z-30 border-b border-white/6 bg-ink-950/90 backdrop-blur-md">
    <div class="mx-auto max-w-[1440px] px-4 py-3 sm:px-6 lg:px-10 lg:py-3.5">
      <div class="scrollbar-none -mx-4 overflow-x-auto px-4 sm:mx-0 sm:px-0">
        <div class="mx-auto flex w-max gap-0.5 rounded-xl bg-black/35 p-1 sm:gap-1 sm:rounded-2xl sm:p-[5px]" role="tablist" aria-label="Categories">
          <button
            ...
            class="relative flex h-9 shrink-0 items-center gap-1.5 overflow-hidden rounded-lg px-3 text-[12.5px] sm:h-[42px] sm:gap-[9px] sm:px-4 sm:text-[13.5px] font-semibold whitespace-nowrap transition-[background-color,color,box-shadow] duration-300 ease-out-quint"
            :class="model === cat.key
          ...
          >
            ...
            <Icon
              :name="cat.icon"
              class="size-3.5 transition-colors duration-300 sm:size-4"
